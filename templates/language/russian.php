...
return array(
	...
	'blogs_personal_title' => 'Категория',
	'blogs_personal_description' => 'Это ваш персональный блог.',
	'blog_closed' => 'Закрытая категория',
	...
	'blog_delete' => 'Удалить',
	'blog_create' => 'Создание новой категории',
	'blog_create_acl' => 'Вы еще не достаточно окрепли, чтобы создавать свой блог',
	'blog_create_title' => 'Название категории',
	'blog_create_title_notice' => 'Название категории должно быть наполнено смыслом, чтобы можно было понять, о чем она.',
	'blog_create_title_error' => 'Название категории должно быть от 2 до 200 символов',
	'blog_create_title_error_unique' => 'Категория с таким названием уже существует',
	'blog_create_url' => 'URL категории',
	'blog_create_url_notice' => 'URL категории, по которому он будет доступен. Может содержать только буквы латинского алфавита, цифры, дефис; пробелы будут заменены на "_". По смыслу URL  должен совпадать с названием блога, после его создания редактирование этого параметра будет недоступно',
	'blog_create_url_error' => 'URL категории должен быть от 2 до 50 символов и только на латинице + цифры и знаки "-", "_"',
	'blog_create_url_error_badword' => 'URL категории должен отличаться от:',
	'blog_create_url_error_unique' => 'Категория с таким URL уже существует',
	'blog_create_description' => 'Описание категории',
	'blog_create_description_notice' => 'Между прочим, можно использовать html-теги',
	'blog_create_description_error' => 'Текст описания категории должен быть от 10 до 3000 символов',
	'blog_create_type' => 'Тип категории',
	'blog_create_type_open' => 'Открытый',
	'blog_create_type_close' => 'Закрытый',
	'blog_create_type_open_notice' => 'Открытый — к этой категории может присоединиться любой желающий, топики видны всем',
	...
	'blog_create_type_error' => 'Неизвестный тип категории',
	'blog_create_rating' => 'Ограничение по рейтингу',
	'blog_create_rating_notice' => 'Рейтинг, который необходим пользователю, чтобы написать в эту категорию',
	...
	'blog_create_submit_notice' => 'После нажатия на кнопку «Сохранить» категория будет создана',
	/**
	 * Управление блогом
	 */
	'blog_admin' => 'Управление категорией',
