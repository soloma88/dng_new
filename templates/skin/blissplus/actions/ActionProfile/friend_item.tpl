{if $oUserFriend and ($oUserFriend->getFriendStatus()==$USER_FRIEND_ACCEPT+$USER_FRIEND_OFFER or $oUserFriend->getFriendStatus()==$USER_FRIEND_ACCEPT+$USER_FRIEND_ACCEPT)}
    <li id="delete_friend_item"><a href="#" class="button button-actions friendadd" title="{$aLang.user_friend_del}" onclick="return ls.user.removeFriend(this,{$oUserProfile->getId()},'del');"><i class="fa fa-minus"></i>{$aLang.user_friend_del}</a></li>
{elseif $oUserFriend and $oUserFriend->getStatusTo()==$USER_FRIEND_REJECT and $oUserFriend->getStatusFrom()==$USER_FRIEND_OFFER and $oUserFriend->getUserTo()==$oUserCurrent->getId()}
    <li id="add_friend_item"><a href="#"  title="{$aLang.user_friend_add}" onclick="return ls.user.addFriend(this,{$oUserProfile->getId()},'accept');"><i class="fa fa-plus"></i>{$aLang.user_friend_add}</a></li>
{elseif $oUserFriend and $oUserFriend->getFriendStatus()==$USER_FRIEND_OFFER+$USER_FRIEND_REJECT and $oUserFriend->getUserTo()!=$oUserCurrent->getId()}
    <li><span class="friendadd">{$aLang.user_friend_offer_reject}</span></li>
{elseif $oUserFriend and $oUserFriend->getFriendStatus()==$USER_FRIEND_OFFER+$USER_FRIEND_NULL and $oUserFriend->getUserFrom()==$oUserCurrent->getId()}
    <li><span class="friendadd">{$aLang.user_friend_offer_send}</li>
...
{elseif !$oUserFriend}
    ...
    <li id="add_friend_item"><a href="#" class="button button-actions friendadd" title="{$aLang.user_friend_add}" id="add_friend_show"><i class="fa fa-plus"></i>{$aLang.user_friend_add}</a></li>
{else}
    <li id="add_friend_item"><a href="#" class="button button-actions friendadd" title="{$aLang.user_friend_add}" onclick="return ls.user.addFriend(this,{$oUserProfile->getId()},'link');"><i class="fa fa-plus"></i>{$aLang.user_friend_add}</a></li>
{/if}
