{if $aPaging and $aPaging.iCountPage>1} 
	<div class="pagination">
		<ul>
			{if $aPaging.iCurrentPage>1}<li><a href="{$aPaging.sBaseUrl}/{$aPaging.sGetParams}" class="js-paging-first" title="{$aLang.paging_first}"><<</a></li>{/if}
			...
			{if $aPaging.iCurrentPage<$aPaging.iCountPage}<li><a href="{$aPaging.sBaseUrl}/page{$aPaging.iCountPage}/{$aPaging.sGetParams}" class="js-paging-last" title="{$aLang.paging_last}">>></a></li>{/if}
		</ul>
	</div>
{/if}