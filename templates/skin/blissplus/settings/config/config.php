...
/* Fixed settings */
$config['view']['grid']['fixed_width'] = 1040;


$config['head']['default']['js'] = Config::Get('head.default.js');
$config['head']['default']['js'][] = '___path.static.skin___/js/template.js';
$config['head']['default']['js'][] = '___path.static.skin___/lib/masonry/masonry.pkgd.min.js';
...
$config['head']['default']['css'] = array(
    ...
    "___path.static.skin___/css/new.css",
    "___path.static.skin___/css/markItUp.css",
    "___path.static.skin___/font-awesome/css/font-awesome.css" => array('merge'=>false),
);
